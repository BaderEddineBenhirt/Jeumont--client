...
export class ConfigComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    // Subscribe to navigation events to update currentRoute on NavigationEnd
  ...
  ngOnDestroy() {
    this.ngUnsubscribe.next(); // Calling next() with no argument to signal completion
    this.ngUnsubscribe.complete(); // Completing the subject
  }
